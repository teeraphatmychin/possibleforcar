  ...
  <head>
    ...
    <link rel="stylesheet" href="{{asset('frontend/template-skytheme/plugins/font-awesome/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/template-skytheme/plugins/ps-icon/style.css')}}">
    <!-- CSS Library-->
    <link rel="stylesheet" href="{{asset('frontend/template-skytheme/plugins/bootstrap/dist/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/template-skytheme/plugins/owl-carousel/assets/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/template-skytheme/plugins/jquery-bar-rating/dist/themes/fontawesome-stars.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/template-skytheme/plugins/slick/slick/slick.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/template-skytheme/plugins/bootstrap-select/dist/css/bootstrap-select.min.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/template-skytheme/plugins/Magnific-Popup/dist/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/template-skytheme/plugins/jquery-ui/jquery-ui.min.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/template-skytheme/plugins/revolution/css/settings.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/template-skytheme/plugins/revolution/css/layers.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/template-skytheme/plugins/revolution/css/navigation.css')}}">
    <!-- Custom-->
    <link rel="stylesheet" href="{{asset('frontend/template-skytheme/css/style.css')}}">
