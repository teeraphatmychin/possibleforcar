...
<head>
  ...
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="{{ asset('frontend/adminlte/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css')}}">
  <!-- Toastr -->
  <link rel="stylesheet" href="{{ asset('frontend/adminlte/plugins/toastr/toastr.min.css')}}">
  <!-- Theme style -->
...
<!-- SweetAlert2 -->
<script src="{{ asset('frontend/adminlte/plugins/sweetalert2/sweetalert2.min.js')}}"></script>
<!-- Toastr -->
<script src="{{ asset('frontend/adminlte/plugins/toastr/toastr.min.js')}}"></script>
<!-- AdminLTE App -->
  ...
  $(function() {
    ...
    $('.toastsDefaultFullImage').click(function() {
      $(document).Toasts('create', {
        ...
        title: 'Toast Title',
        subtitle: 'Subtitle',
        image: '{{ asset('frontend/adminlte/dist/img/user3-128x128.jpg')}}',
