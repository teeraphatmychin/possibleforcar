...
<head>
  ...
  <!-- Ion Slider -->
  <link rel="stylesheet" href="{{ asset('frontend/adminlte/plugins/ion-rangeslider/css/ion.rangeSlider.min.css')}}">
  <!-- bootstrap slider -->
  <link rel="stylesheet" href="{{ asset('frontend/adminlte/plugins/bootstrap-slider/css/bootstrap-slider.min.css')}}">
  <!-- Theme style -->
...
<!-- Ion Slider -->
<script src="{{ asset('frontend/adminlte/plugins/ion-rangeslider/js/ion.rangeSlider.min.js')}}"></script>
<!-- Bootstrap slider -->
<script src="{{ asset('frontend/adminlte/plugins/bootstrap-slider/bootstrap-slider.min.js')}}"></script>
<script>
  $(function () {
    /* BOOTSTRAP SLIDER */
