...
<!-- Ekko Lightbox -->
<script src="{{ asset('frontend/adminlte/plugins/ekko-lightbox/ekko-lightbox.min.js')}}"></script>
<!-- AdminLTE App -->
...
<!-- Filterizr-->
<script src="{{ asset('frontend/adminlte/plugins/filterizr/jquery.filterizr.min.js')}}"></script>
